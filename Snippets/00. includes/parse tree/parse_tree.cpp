...
treeNode* buildParseTree(){
    ...
    treeNode *returnValue = stack_a_pop_tree_node(&stack);
    return returnValue;
}
...
void draw_binary_tree_iterative(treeNode *t){
    putchar(10);
...
void draw_binary_tree_recursive(treeNode *t){
